...
## Goals
The goal of this project is to run Predictive Classification Models and find out with how much accuracy I can predict Heart Conditions in regards to Categories such as Age, Race & Gender etc. It will help us find out which Category is more at risk of Heart disease and may help create better health plans for the members in the future.
